            ...
            <Form ref="updateForm" :model="updateForm" :rules="ruleCustom" :label-width="80">
                ...
                <Row>
                    ...
                    <FormItem label="签单日期" prop="signingDate"  >
                        <DatePicker type="date" v-model="updateForm.signingDate" format="yyyy-MM-dd" placeholder="Select date" style="width: 200px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <FormItem label="船期" prop="shipTime"  >
                        <DatePicker type="date" v-model="updateForm.shipTime" format="yyyy-MM-dd" placeholder="Select date" style="width: 200px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <FormItem label="交货日期" prop="deliveryPeriod"  >
                        <DatePicker type="date" v-model="updateForm.deliveryPeriod" format="yyyy-MM-dd" placeholder="Select date" style="width: 200px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
        ...
        <Modal
            ...
            <Form ref="addForm" :model="addForm" :rules="ruleCustom" :label-width="80">
                ...
                <Row>
                    ...
                    <Col span="11">
                    <FormItem label="签单日期" prop="signingDate"  >
                        <DatePicker type="date" v-model="addForm.signingDate" format="yyyy-MM-dd" placeholder="Select date" style="width: 200px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <Col span="11">
                    <FormItem label="船期" prop="shipTime"  >
                        <DatePicker type="date" v-model="addForm.shipTime" format="yyyy-MM-dd" placeholder="Select date" style="width: 200px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <Col span="11">
                    <FormItem label="交货日期" prop="deliveryPeriod"  >
                        <DatePicker type="date" v-model="addForm.deliveryPeriod" format="yyyy-MM-dd" placeholder="Select date" style="width: 200px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
...
//                    this.updateForm=this.data1[index];
                }
            ...
            update (contractName) {
                this.data1[this.tempIndex].contractName=this.updateForm.contractName;
                const contract = this.data1[this.tempIndex];
            ...
            handleReset (contractName) {
                this.$refs[contractName].resetFields();
            },
            gopage(pageNo){
