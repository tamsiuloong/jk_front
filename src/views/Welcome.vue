<template>
 ...
 <!--<Row >-->
    ...
    <!--<Col :sm="24" :md="8">-->
        <!--<h3>👍杰信综合信息管理平台👍</h3>-->
        <!--&lt;!&ndash;<h5> <a href="https://github.com/herozhou/vue-framework-wz" target="_blank">github地址（喜欢就点个start呗）</a>  </h5>&ndash;&gt;-->
    <!--</Col>-->
        <!---->

        <!--&lt;!&ndash;<div class="state-info">&ndash;&gt;-->

              <!--&lt;!&ndash;<section class="panel">&ndash;&gt;-->
                    <!--&lt;!&ndash;<div class="panel-body">&ndash;&gt;-->
                        <!--&lt;!&ndash;<div class="summary">&ndash;&gt;-->
                            <!--&lt;!&ndash;<span>yearly  income</span>&ndash;&gt;-->
                            <!--&lt;!&ndash;<h3 class="green-txt">$ 45,600</h3>&ndash;&gt;-->
                        <!--&lt;!&ndash;</div>&ndash;&gt;-->
                         <!--&lt;!&ndash;&ndash;&gt;-->
                        <!--&lt;!&ndash;<div id="expense" class="chart-bar"> <img src="static/img/greenincome.png"></div>&ndash;&gt;-->
                    <!--&lt;!&ndash;</div>&ndash;&gt;-->
                <!--&lt;!&ndash;</section>&ndash;&gt;-->
               ...
               <!--&lt;!&ndash;<section class="panel">&ndash;&gt;-->
                 ...
                 <!--&lt;!&ndash;<div class="panel-body">&ndash;&gt;-->
                  <!--&lt;!&ndash;&ndash;&gt;-->
                        <!--&lt;!&ndash;<div class="summary">&ndash;&gt;-->
                            <!--&lt;!&ndash;<span>yearly expense</span>&ndash;&gt;-->
                            <!--&lt;!&ndash;<h3 class="red-txt">$ 45,600</h3>&ndash;&gt;-->
                        <!--&lt;!&ndash;</div>&ndash;&gt;-->
                        <!--&lt;!&ndash;<div id="income" class="chart-bar">&ndash;&gt;-->
                          <!--&lt;!&ndash;<img src="static/img/redincome.png">&ndash;&gt;-->
                          <!--&lt;!&ndash;&ndash;&gt;-->
...
export default {
  ...
  name: 'dashboard',
        ...
        mounted(){
             ...
             this.$Notice.success({
                    title: '欢迎您使用杰信商务综合信息管理平台',
                    desc:  `您的账号令牌是:<br> ${token}`,
                    duration: 10
                });
